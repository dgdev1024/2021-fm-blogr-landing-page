...
function SvgBgPatternIntro(props) {
  return (
    <svg width={3175} height={3174} {...props}>
      <defs>
        <linearGradient
          id="bg-pattern-intro_svg__a"
          x1=".639%"
          x2="99.361%"
          y1="0%"
          y2="100%"
      ...
      <path
        fill="url(#bg-pattern-intro_svg__a)"
        fillRule="evenodd"
...
export default SvgBgPatternIntro;
